...
export default function DashboardPage() {
  return (
    <div className={styles.dashboard}>
      ...
      <div style={{ background: '#f8fafc', height: '140px', position: 'relative', borderBottom: '1px solid #e2e8f0' }}>
         {/* Background Map Placeholder (we just use a solid color per the clean design) */}
